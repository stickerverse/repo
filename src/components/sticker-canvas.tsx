...
export function StickerCanvas({ files, setFiles, sizeOption, gridOption, product }: StickerCanvasProps) {
  ...
  return (
    <div className="space-y-6">
      <div className={`relative ${getCanvasAspect()} w-full h-auto min-h-[300px] md:min-h-[400px] bg-card/80 border-dashed border-2 border-border hover:border-accent transition-all duration-300 ease-in-out flex items-center justify-center overflow-hidden shadow-2xl rounded-lg`}>
